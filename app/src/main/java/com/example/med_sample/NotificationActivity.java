...
public class NotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bnw != null){
            bnw.setOnItemSelectedListener(navListener);
        } else{
    ...
    private final BottomNavigationView.OnItemSelectedListener navListener = item -> {
        ...
        if (item.getItemId() == R.id.nav_home) {
            ...
            if (ContextCompat.checkSelfPermission(NotificationActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            Intent intent = new Intent(NotificationActivity.this, DisplayScanned.class);
